.ALIASES
_    bitSlice(Cout=COUT a=N00490 b=N00478 Cin=N00510 op[2]=N00455 op[1]=N00448 op[0]=N00441 less=0 result=RESULT ) CN 
+@PCB_ASSIGN1.SCHEMATIC3(sch_1):bitSlice@PCB_ASSIGN1.SCHEMATIC2(sch_1)
_    bitSlice.fullAdd(a=bitSlice_N00153 b=bitSlice_N00166 c_in=bitSlice_N00146 c_out=COUT sum=bitSlice_SUM ) CN 
...
X_bitSlice_fullAdd_U3A          bitSlice.fullAdd.U3A(A=bitSlice_fullAdd_N00737 B=bitSlice_fullAdd_N00744 Y=COUT VCC=$G_DPWR
+GND=$G_DGND ) CN
...
_    _(bitSlice.fullAdd.c_out=COUT)
...
_    bitSlice.FA(a=N00490 b=bitSlice_N01053 c_in=N00510 c_out=COUT sum=bitSlice_N01275 ) CN 
...
X_bitSlice_FA_U3A          bitSlice.FA.U3A(A=bitSlice_FA_N00737 B=bitSlice_FA_N00744 Y=COUT VCC=$G_DPWR GND=$G_DGND ) CN
